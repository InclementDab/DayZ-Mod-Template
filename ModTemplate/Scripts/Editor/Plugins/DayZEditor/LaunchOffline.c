...
class LaunchOfflineModTool: DayZProjectManager
{
	override void Run()
	{
		RunDayZBat("P:\\ModTemplate\\workbench\\Batchfiles\\Exit.bat", true);
		RunDayZBat("P:\\ModTemplate\\workbench\\Batchfiles\\LaunchOffline.bat", true);
	}
}
...
class OpenLogFiles: DayZProjectManager
{
	...
	override void Run()
	{
		RunDayZBat("P:\\ModTemplate\\Workbench\\Batchfiles\\OpenLogs.bat", true);
	}
}
...
class BuildMod: DayZProjectManager
{
	override void Run()
	{
		RunDayZBatList({"P:\\ModTemplate\\Workbench\\Batchfiles\\Exit.bat", "P:\\DayZEditor\\workbench\\Batchfiles\\ZBinarizeDeploy.bat"});
	}
}
...
class BuildModAndLaunch: DayZProjectManager
{
	override void Run()
	{
		RunDayZBatList({"P:\\ModTemplate\\workbench\\Batchfiles\\Exit.bat", "P:\\DayZEditor\\workbench\\Batchfiles\\ZBinarizeDeploy.bat", "P:\\DayZEditor\\workbench\\Batchfiles\\LaunchOffline.bat"});
	}
}
...
class LaunchServer: DayZProjectManager
{
	...
	{
		RunDayZBat("P:\\ModTemplate\\workbench\\Batchfiles\\Exit.bat", true);
		RunDayZBat("P:\\ModTemplate\\workbench\\Batchfiles\\ZBinarizeDeploy.bat", true);
		RunDayZBat("P:\\ModTemplate\\workbench\\Batchfiles\\LaunchServer.bat");
		RunDayZBat("P:\\ModTemplate\\workbench\\Batchfiles\\LaunchLocalMP.bat");
	}
}
